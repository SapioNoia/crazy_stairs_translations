...
module.tutorial = {
	...
	["tut_big_9"] = "당신은 이제 Keeper입니다, 이 주문을 사용해서 계단을 움직여보세요.",
	["tut_big_10"] = "계단을 이동시키기 위해 앞쪽을 향하는 화살표 위로 점프하세요.",
	["tut_big_11"] = "게임을 하면서 경로를 가로막는 계단들을 많이 발견하게 될 것입니다.",
	["tut_big_12"] = "당신은 이제 Wicked입니다, 이 주문을 사용하여 가로막는 계단을 파괴하세요.",
	["tut_big_13"] = "바로 아래 계단에서 점프함으로서 길을 가로막는 위쪽 계단도 파괴할 수 있습니다.",
