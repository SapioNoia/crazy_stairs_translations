...
module.spells.descriptions = {
	...
	--KEEPER
	["move"] = "이 주문은 계단을 수평하게 이동시키며, 이동 경로에 있는 계단을 파괴합니다. 주문 시전 후, 화살표가 계단에 나타나며, 이동 방향을 선택하게 할 것입니다. 계단은 게임 경계 외부로 이동할 수 없습니다. CONTROLLER 등급은 저주받지 않은 모든 계단을 이동할 수 있습니다.",
	["rotate"] = "이 주문은 계단을 수평하게 회전하며, 이동 경로에 있는 계단을 파괴합니다. After casting, arrows will appear on stairs, prompting you to choose direction. Stairs cannot be rotated outside the game area. Rank up to CONTROLLER to move any un-cursed stairs.",
